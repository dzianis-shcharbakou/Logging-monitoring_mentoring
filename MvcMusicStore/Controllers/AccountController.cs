...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            //ReportGenerator logParse = new ReportGenerator();
            //logParse.GenerateScript();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    logger.Info($"User {user.UserName} login in the system");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    PerformanceCounterCreator.RegistrationUserIncriment();

                    logger.Info($"User {user.UserName} registred in the system");
        ...
        public ActionResult LogOff()
        {
            ...
            PerformanceCounterCreator.SuccessfulLogoutIncriment();
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            PerformanceCounterCreator.SuccessfulLoginIncriment();
        }
